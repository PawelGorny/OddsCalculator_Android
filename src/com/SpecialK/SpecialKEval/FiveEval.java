...
public class FiveEval {
	...
	public void initialiseDeck(){
		...
		int[] face={		Constants.ACE_FIVE, Constants.KING_FIVE, Constants.QUEEN_FIVE, Constants.JACK_FIVE,
	...
	public void initialiseRanking(){
		...
		rankArray = new int[Constants.MAX_FIVE_NONFLUSH_KEY_INT+1];
		flushRankArray = new int[Constants.MAX_FLUSH_KEY_INT+1];
		
		int[] face={		Constants.TWO_FIVE, Constants.THREE_FIVE, Constants.FOUR_FIVE, Constants.FIVE_FIVE,
		...
		int[] faceflush={	Constants.TWO_FLUSH, Constants.THREE_FLUSH, Constants.FOUR_FLUSH, Constants.FIVE_FLUSH,
	...
	for(i=0; i<Constants.MAX_FIVE_NONFLUSH_KEY_INT+1; i++){rankArray[i]=0;}
